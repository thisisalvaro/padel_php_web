...
class CalendarService {
    ...
    // Mostrar los horarios disponibles por consola (en el navegador, es posible con `echo`)
    echo "<script>console.log('Horarios disponibles: " . implode(", ", $horariosDisponibles) . "');</script>";
